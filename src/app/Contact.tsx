            ...
            <ul className="list-unstyled mt-4 lh-lg">
              ...
              <li>
                ...
                <a href="https://www.youtube.com/@repair4483" target="_blank">
                  <img
                    src="https://developers.google.com/site-assets/logo-youtube.svg"
                    width="40"
                    style={{ margin: "5px" }}
                    alt="YouTube 채널 바로가기"
                  />
