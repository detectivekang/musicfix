  ...
  return (
    <section id="history" className="bg-light py-5">
      <div className="container">
        <h2 className="fw-bold text-center mb-5">연혁</h2>
        <div className="row g-4">
          <div className="col-md-4">
            <div className="p-4 bg-white shadow rounded-4 h-100">
              <h4 className="fw-bold">2000-2020</h4>
          ...
          <div className="col-md-4">
            <div className="p-4 bg-white shadow rounded-4 h-100">
              <h4 className="fw-bold">2025</h4>
              <p className="small text-muted mb-1">글로벌 서비스 런칭</p>
              <p className="mb-0">해외 고객 비중 40% 돌파</p>
            </div>
          </div>
        </div>
      </div>
